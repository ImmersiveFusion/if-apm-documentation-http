...
|-----------|-----------|
| Tessa chat + voice | Yes |
| Workspaces + artifacts | Yes |
| Org knowledge | Yes |
| APM data queries (via Tessa) | Yes |
| 3D visualization | No |
| Enter grids (3D) | No |
...
| Surface | Best For |
|---------|----------|
| [IAPM (3D & VR)](../3D/index.md) | Deep 3D investigation, spatial visualization, VR immersion |
